...
<div class="messenger">
    ...
    <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">ОАТОС</span> </a>
                {{-- header buttons --}}
        ...
        <div class="m-body contacts-container">
           ...
           <div class="show messenger-tab users-tab app-scroll" data-view="users">
               ...
               {{-- Saved Messages --}}
               <p class="messenger-title"><span>Чат</span></p>
           ...
           <div class="messenger-tab search-tab app-scroll" data-view="search">
                ...
                <div class="search-records">
                    <p class="message-hint center-el"><span>Напишите, что бы найти..</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-body messages-container app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>Выберите чат для диалога</span></p>
            </div>
            {{-- Typing indicator --}}
